...
export default function HousingPriceLineChart({ data }: HousingPriceLineChartProps) {
  ...
  return (
    <div className="flex flex-col gap-4 lg:flex-row">
      ...
      <div className="lg:w-44 shrink-0 pt-2">
        <p className="mb-2 text-xs font-semibold text-muted">Growth since 2012</p>
        <div className="grid grid-cols-2 gap-x-4 gap-y-1.5 lg:grid-cols-1 lg:gap-x-0">
          {data.map((p, i) => (
            <div key={p.province} className="flex items-center justify-between text-xs">
